...
], Comment.prototype, "commentAuthor", void 0);
__decorate([
    class_validator_1.IsCurrency(),
    typeorm_1.Column('money'),
    __metadata("design:type", String)
], Comment.prototype, "price", void 0);
__decorate([
    class_validator_1.IsString(),
...
__decorate([
    typeorm_1.ManyToOne(() => entity_1.default, ticket => ticket.comments),
    __metadata("design:type", entity_1.default)
], Comment.prototype, "ticket", void 0);
__decorate([
    typeorm_1.ManyToOne(() => entity_2.default, user => user.comments),
